...
local function pointHelp(player)
	...
	player:PrintToPlayer("  !setpoint commands:",21);
	player:PrintToPlayer("----------------------------", 21);
	player:PrintToPlayer("  To create a new set point type:",21);
	player:PrintToPlayer("  !setpoint <number> <an optional description>",21);
	player:PrintToPlayer("  To goto a set point: !setpoint goto <number>",21);
	player:PrintToPlayer("  To view your set point descriptions: !setpoint list",21);
	player:PrintToPlayer("  To delete a set point:  !setpoint del <number>",21);
	player:PrintToPlayer("  To Delete all set points: !setpoint del all",21);
	player:PrintToPlayer("  * <number> must be a value between and including 1 and 9.", 21);
	player:PrintToPlayer("------------------------------", 21);
...
local function createPoint(player,pointNumber,description)
	...
	if (player:isInMogHouse()) then
		player:PrintToPlayer("Cannot create a point here.",21);
		return;
	end
	
	
	if player:getZoneID() == 6 or player:getZoneID() == 8 or player:getZoneID() == 10 or player:getZoneID() == 13 or player:getZoneID() == 14 
		or player:getZoneID() == 15 or player:getZoneID() == 16 or player:getZoneID() == 17 or player:getZoneID() == 18 or player:getZoneID() == 19 
		or player:getZoneID() == 20 or player:getZoneID() == 21 or player:getZoneID() == 22 or player:getZoneID() == 23 or player:getZoneID() == 31 
		or player:getZoneID() == 33 or player:getZoneID() == 34 or player:getZoneID() == 35 or player:getZoneID() == 36 or player:getZoneID() == 37 
		or player:getZoneID() == 38 or player:getZoneID() == 39 or player:getZoneID() == 40 or player:getZoneID() == 41 or player:getZoneID() == 42 
		or player:getZoneID() == 45 or player:getZoneID() == 46 or player:getZoneID() == 47 or player:getZoneID() == 51 or player:getZoneID() == 54 
		or player:getZoneID() == 55 or player:getZoneID() == 56 or player:getZoneID() == 58 or player:getZoneID() == 59 or player:getZoneID() == 60 
		or player:getZoneID() == 61 or player:getZoneID() == 62 or player:getZoneID() == 63 or player:getZoneID() == 64 or player:getZoneID() == 65 
		or player:getZoneID() == 66 or player:getZoneID() == 69 or player:getZoneID() == 73 or player:getZoneID() == 74 or player:getZoneID() == 75 
		or player:getZoneID() == 76 or player:getZoneID() == 77 or player:getZoneID() == 78 or player:getZoneID() == 79 or player:getZoneID() == 85 
		or player:getZoneID() == 92 or player:getZoneID() == 99 or player:getZoneID() == 127 or player:getZoneID() == 128 or player:getZoneID() == 130 
		or player:getZoneID() == 131 or player:getZoneID() == 132 or player:getZoneID() == 134 or player:getZoneID() == 135 or player:getZoneID() == 136 
		or player:getZoneID() == 139 or player:getZoneID() == 146 or player:getZoneID() == 148 or player:getZoneID() == 150 or player:getZoneID() == 151 
		or player:getZoneID() == 152 or player:getZoneID() == 154 or player:getZoneID() == 163 or player:getZoneID() == 164 or player:getZoneID() == 165 
		or player:getZoneID() == 168 or player:getZoneID() == 170 or player:getZoneID() == 171 or player:getZoneID() == 175 or player:getZoneID() == 177 
		or player:getZoneID() == 178 or player:getZoneID() == 179 or player:getZoneID() == 180 or player:getZoneID() == 181 or player:getZoneID() == 182 
		or player:getZoneID() == 185 or player:getZoneID() == 186 or player:getZoneID() == 187 or player:getZoneID() == 188 or player:getZoneID() == 190 
		or player:getZoneID() == 201 or player:getZoneID() == 202 or player:getZoneID() == 203 or player:getZoneID() == 206 or player:getZoneID() == 207 
		or player:getZoneID() == 209 or player:getZoneID() == 211 or player:getZoneID() == 213 or player:getZoneID() == 220 or player:getZoneID() == 221 
		or player:getZoneID() == 223 or player:getZoneID() == 224 or player:getZoneID() == 225 or player:getZoneID() == 226 or player:getZoneID() == 227 
		or player:getZoneID() == 228 or player:getZoneID() == 251 or player:getZoneID() == 255 or player:getZoneID() == 7 then
		player:PrintToPlayer("You may not create a setpoint in this zone.",21);
		return;
	end

	if (checkPointNumber(pointNumber) == false) then
		player:PrintToPlayer("Set point '" .. pointNumber .. "' is not a valid set point.",21);
		return;
	end
	...
	player:PrintToPlayer(string.format("New Setpoint " .. pointNumber .. " created in ".. zoneName .."."),21);
...
local function delPoint(player,pointNumber)
	...
	if (pointNumber == "all") then
		...
		player:PrintToPlayer("All set points deleted.",21);
	else
		if (checkPointNumber(pointNumber) == false) then
			player:PrintToPlayer("Set point '" .. pointNumber .. "' is not a valid set point.",21);
			return;
		...
		player:PrintToPlayer("Set point " .. pointNumber .. " has been deleted.",21);
	end
end;
...
local function gotoPoint(player,pointNumber)
	...
	if (player:isInMogHouse()) then
		player:PrintToPlayer("You may not use this command while in the Mog House!",21);
		return;
	end
	...
	if player:getZoneID() == 6 or player:getZoneID() == 8 or player:getZoneID() == 10 or player:getZoneID() == 13 or player:getZoneID() == 14 
		...
		or player:getZoneID() == 209 or player:getZoneID() == 211 or player:getZoneID() == 213 or player:getZoneID() == 220 or player:getZoneID() == 221 
		or player:getZoneID() == 223 or player:getZoneID() == 224 or player:getZoneID() == 225 or player:getZoneID() == 226 or player:getZoneID() == 227 
		or player:getZoneID() == 228 or player:getZoneID() == 251 or player:getZoneID() == 255 then
		player:PrintToPlayer("The !setpoint command cannot be used in this zone.  Please proceed to a non-restricted zone to use !setpoint.",21);
		return;
	end
	...
	if (zone ~= 0) then
		...
		player:PrintToPlayer("Set point " .. pointNumber .. " has not been set.",21);
	end
end;
