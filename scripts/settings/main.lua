...
xi.settings =
{
    ...
    BOOK_EXP_RATE   = 1.500, -- Multiplies exp from FoV/GoV book pages.
    ...
    -- DYNAMIS SETTINGS
    BETWEEN_2DYNA_WAIT_TIME     = 4,       -- Hours before player can re-enter Dynamis. Default is 1 Earthday (24 hours).
