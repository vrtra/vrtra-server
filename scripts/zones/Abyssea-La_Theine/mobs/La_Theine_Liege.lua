...
entity.onMobDeath = function(mob,player)
    ...
    if player:hasKeyItem(xi.ki.PELLUCID_FLY_EYE) == false then
        player:addKeyItem(xi.ki.PELLUCID_FLY_EYE)
        player:messageSpecial(ID.text.KEYITEM_OBTAINED, xi.ki.PELLUCID_FLY_EYE)
