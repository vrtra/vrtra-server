...
entity.onMobDeath = function(mob,player)
    ...
    if player:hasKeyItem(xi.ki.WARPED_GIGAS_ARMBAND) == false then
        player:addKeyItem(xi.ki.WARPED_GIGAS_ARMBAND)
        player:messageSpecial(ID.text.KEYITEM_OBTAINED, xi.ki.WARPED_GIGAS_ARMBAND)
