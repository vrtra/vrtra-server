...
entity.onMobDeath = function(mob,player)
    ...
    if (player:hasKeyItem(xi.ki.FRAGRANT_TREANT_PETAL) == false) then
        player:addKeyItem(xi.ki.FRAGRANT_TREANT_PETAL)
        player:messageSpecial(ID.text.KEYITEM_OBTAINED, xi.ki.FRAGRANT_TREANT_PETAL)
