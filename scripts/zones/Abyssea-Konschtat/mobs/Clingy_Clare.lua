...
entity.onMobDeath = function(mob,player)
    ...
    if (player:hasKeyItem(xi.ki.DECAYING_MORBOL_TOOTH) == false) then
        player:addKeyItem(xi.ki.DECAYING_MORBOL_TOOTH)
        player:messageSpecial(ID.text.KEYITEM_OBTAINED, xi.ki.DECAYING_MORBOL_TOOTH)
